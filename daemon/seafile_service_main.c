...
void*
start_thrift_server (void *args)
{
  SeafileServiceHandler *handler;
  SeafileProcessor *processor;
  ...
  handler =
    g_object_new (TYPE_SEAFILE_SERVICE_HANDLER,
                  NULL);
  ...
  processor =
    g_object_new (TYPE_SEAFILE_PROCESSOR,
                  "handler", handler,
                  NULL);
